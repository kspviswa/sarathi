...
from sarathy.agent.tools.filesystem import ReadFileTool, WriteFileTool, EditFileTool, ListDirTool
from sarathy.agent.tools.shell import ExecTool
from sarathy.agent.tools.web import WebSearchTool, WebFetchTool
...
class SubagentManager:
    ...
    async def _run_subagent(
        ...
        try:
            ...
            tools.register(WebSearchTool(api_key=self.brave_api_key, provider=self.web_search_provider))
